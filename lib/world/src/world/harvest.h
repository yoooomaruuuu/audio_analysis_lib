...
//   f0                   : F0 contour.
//-----------------------------------------------------------------------------
WORLD_API void Harvest(const double *x, int x_length, int fs,
...
//-----------------------------------------------------------------------------
WORLD_API void InitializeHarvestOption(HarvestOption *option);
...
//-----------------------------------------------------------------------------
WORLD_API int GetSamplesForHarvest(int fs, int x_length, double frame_period);
